    ...
    <form action="../controller/specificParcel.php" method="POST">
        ...
        <tr>
            ...
            <td width="1250px" colspan="2">
                <table border="0" cellspacing="0" align="center" width="1200px" cellpadding="10">
            ...
            <tr>
                ...
                <td align="center">
                    <a href="empEdit.php?IdEMP=<?php echo $users[$i]['EmpID'] ?>" name="edit"
                        style="color: Green; font-size:22px;"><i class="fa-solid fa-pen-to-square"></i></a>
                </td>
                <td align="center"> <a href="empDelete.php?IdEMP=<?php echo $users[$i]['EmpID'] ?>"" name="delete" style="color: Red; font-size:22px;"><i class="fa-solid fa-trash-can"></i></a></td>
            </tr>
        <?php } ?>
        </td>
        </tr>
